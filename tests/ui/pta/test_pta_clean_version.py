...
# pylint: disable=[ungrouped-imports, unused-argument, too-many-positional-arguments, too-many-arguments]
...
class TestPTACleanVersion:
    """
    Test cases for PTA Application – Playwright version.
    ...
    # @pytest.mark.skip
    def test_pta_login(self, page, request, testdata, region, log):
        """
    ...
    # @pytest.mark.skip
    def test_pta_header_links(self, page, request, testdata, region, log):
        """
        ...
        # Map of each header link to its click action and URL fragment for verification.
