...
class TestHeroku:
    ...
    def test_broken_links(self, page, region):
        ...
        self.landingpage = LandingPage(page)
    ...
    # @pytest.mark.skip
    def test_ab_testing(self, page, region):
        """
        ...
        self.landingpage = LandingPage(page)
        self.abtestpage = ABTestPage(page)
    ...
    # @pytest.mark.skip
    def test_add_remove_elements(self, page, region):
        """
        ...
        self.landingpage = LandingPage(page)
        self.addremovepage = AddRemoveElementsPage(page)
    ...
    # @pytest.mark.skip
    def test_basic_auth(self, page, region):
        """
        ...
        self.basicauthpage = BasicAuthPage(page)
    ...
    def test_broken_images(self, page, region):
        ...
        self.landingpage = LandingPage(page)
        self.brokenimagepage = BrokenImagesPage(page)
    ...
    # @pytest.mark.skip
    def test_challenging_dom(self, page, region):
        """
        ...
        fully regenerated and that dynamic re-rendering works correctly.
        ...
        08) Capture initial button IDs before any click.
        09) Click the blue button and verify the button ID changes (DOM regenerated).
        10) Click the red button and verify the button ID changes again.
        11) Click the green button and verify the button ID changes again.
        """
        env_config = ui_test_env_config.get(region.upper(), {})

        self.landingpage = LandingPage(page)
        self.challengingdompage = ChallengingDomPage(page)
    ...
    def test_digest_auth(self, page, region):
        ...
        07) Use Playwright route interception to inject the Authorization header
            computed from the successful requests session, then navigate to /digest_auth.
        ...
        self.digestauthpage = DigestAuthPage(page)
        ...
        try:
            ...
            log.info("  200 OK returned with correct credentials as expected.")
            ...
            log.info("  401 returned with wrong credentials as expected.")
            ...
            log.info("STEP 07: Inject the Digest Authorization header via route interception and navigate to /digest_auth.")
            ...
            # Use Playwright route interception to inject the Authorization header.
            def add_auth_header(route):
                route.continue_(headers={**route.request.headers, "Authorization": auth_header_value})

            page.route("**/digest_auth", add_auth_header)
            page.goto(digest_url)
            ...
            # Always clear the route interception so it doesn't bleed into subsequent tests
            try:
                page.unroute("**/digest_auth")
            except Exception:  # pylint: disable=broad-except
                pass

    # @pytest.mark.skip
    def test_disappearing_elements(self, page, region):
        """
        ...
        self.landingpage = LandingPage(page)
        self.disappearing_elements_page = DisappearingElementsPage(page)
