# pylint: disable = [line-too-long, missing-module-docstring, missing-function-docstring, duplicate-code]
...
device_name = mobile_test_env_config["WDIO"].get("DEVICE_NAME", "Pixel_10_Pro_XL")
