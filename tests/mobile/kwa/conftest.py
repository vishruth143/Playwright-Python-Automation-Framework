...
device_name = mobile_test_env_config['KWA'].get("DEVICE_NAME", "Pixel_10_Pro_XL")
...
def driver(request):
    ...
    if run_on_cloud:
        if cloud_provider == "lambdatest":
            ...
            options.device_name = mobile_test_env_config.get("DEVICE_NAME", "Pixel_10_Pro_XL")
            options.platform_version = mobile_test_env_config.get("PLATFORM_VERSION", "17")
